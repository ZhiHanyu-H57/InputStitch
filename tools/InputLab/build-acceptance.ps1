...
foreach ($name in @(
    ...
    'XInputNative.cs','XInputInput.cs','WindowsDeviceDiscovery.cs','DeviceIdentity.cs','DeviceManagerDialog.cs','GamepadRouter.cs','ControlledReplacement.cs','SlotAcquisition.cs',
